            ...
            <div className=" sm:grid sm:grid-cols-3 xl:grid-cols-4 sm:items-center sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <div className="flex items-center gap-x-3">
                  ...
                  <button
                    type="button"
                    className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold hover:bg-slate-300 duration-300 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 "
                  ...
                  {file && (
                    <>
                      <button
                        type="button"
                        className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-slate-300 duration-300 "
                        onClick={() => {
                          firebase
